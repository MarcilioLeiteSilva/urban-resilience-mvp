...
export default function IncidentsPage() {
  return (
    <AppLayout>
      {/* 1. Header Título */}
      <div>
           <h2 className="text-xl font-black text-slate-900 tracking-tight">Incidentes Ativos</h2>
           <p className="text-xs text-slate-500">Acompanhe as ocorrências em andamento monitoradas pela Defesa Civil.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-center h-96 text-slate-400">
           <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm font-semibold">Módulo de Incidentes em Manutenção Visual</p>
           </div>
      </div>
    </AppLayout>
  );
