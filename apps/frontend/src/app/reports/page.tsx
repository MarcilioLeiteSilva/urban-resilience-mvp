...
export default function ReportsPage() {
  return (
    <AppLayout>
      {/* 1. Header Título */}
      <div>
           <h2 className="text-xl font-black text-slate-900 tracking-tight">Relatos da Comunidade</h2>
           <p className="text-xs text-slate-500">Acompanhe as demandas e chamados submetidos na sua região.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex items-center justify-center h-96 text-slate-400">
           <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm font-semibold">Módulo de Relatos em Manutenção Visual</p>
           </div>
      </div>
    </AppLayout>
  );
